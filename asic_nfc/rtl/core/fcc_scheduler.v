...
reg wpage_1;// Tracks if mid-sequence
reg wpage_2;// Tracks if at last page and waiting for response
...
reg epage_1;// Tracks if mid-sequence
reg epage_2;// Tracks if at last page and waiting for response
...
// Final mux - different categories priority encoded
always@(posedge clk or posedge rst)    
if(rst) begin
